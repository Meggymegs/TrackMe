<?php
	...
	$required = array('timeName');

	$tbl_name = "physical_activities_time_type_table";
	...
	if ($error) {
		...
		//Create food object
		$time = new Time1(trim($_POST['timeName']));

		$name = $time->getTimeName();

		$query = "INSERT INTO `physical_activities_time_type_table`(`physical_activity_time_id`, `physical_activity_time_type`) VALUES ('DEFAULT','$name')";
